...
Although plsmod can fit multivariate models, we'll concentrate on a univariate model that predicts the percentage of protein in the samples.  
...
Note that only some of the available PLS engines support regularization. Other PLS engines will omit the `predictor_prop` argument to fit a traditional PLS model.
